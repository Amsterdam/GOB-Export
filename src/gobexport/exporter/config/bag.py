...
class WoonplaatsenExportConfig:
    ...
    query_actueel = '''
{
  bagWoonplaatsen(sort: identificatie_asc) {
    edges {
      node {
        identificatie
...
class OpenbareruimtesExportConfig:
    ...
    query_actueel = '''
{
  bagOpenbareruimtes(sort: identificatie_asc) {
    edges {
      node {
        identificatie
        heeftOnderzoeken(inOnderzoek: "J") {
...
class StandplaatsenExportConfig:
    ...
    query_actueel = '''
{
  bagStandplaatsen(sort: identificatie_asc) {
    edges {
      node {
        identificatie
        geconstateerd
...
class LigplaatsenExportConfig:
    ...
    query_actueel = '''
{
  bagLigplaatsen(sort: identificatie_asc) {
    edges {
      node {
        identificatie
        heeftOnderzoeken(inOnderzoek: "J") {
...
class OnderzoekenExportConfig:
    ...
    actueel_query = '''
{
    bagOnderzoeken(sort: identificatie_asc, inOnderzoek:"J") {
        edges {
          node {
            objectIdentificatie
            objecttype
...
'''
    ...
    history_query = '''
{
    bagOnderzoeken(active: false, sort:[identificatie_asc, volgnummer_asc]) {
        edges {
          node {
            objectIdentificatie
            volgnummer
