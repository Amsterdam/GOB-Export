...
class MetingenExportConfig:
    ...
    query_metingen = '''
{
  meetboutenMetingen (publiceerbaar: true, identificatie: "10000184", active: false) {
    edges {
      node {
        identificatie
        datum
    ...
    products = {
        'dat': {
            ...
            'format': 'identificatie:num|datum:dat|typeMeting:str|hoogteTovNap:num:4|zakking:num:1|'
                      ...
                      'zakkingCumulatief:num:1|isGemetenDoor:str|hoeveelsteMeting:num|aantalDagen:num:0:True|'
