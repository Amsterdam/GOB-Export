"""BRK2 kadastralesubjecten exports."""
...
class KadastralesubjectenCsvFormat(BrkCsvFormat):
    """CSV format class for BRK2 kadastralesubjecten export."""
    ...
    def _get_person_attrs(self):
        ...
        non_bsn_attrs = {"SJT_KAD_GESLACHTSNAAM": "geslachtsnaam"}
    ...
    def _get_kvk_attrs(self):
        """Return KvK attributes.

        KvK attributes are prefixed with either 'SJT_NNP_' or 'SJT_KAD_'
    ...
    def get_format(self):
        """Return BRK2 kadastralesubjecten CSV format dictionary."""
...
class KadastralesubjectenExportConfig:
    """Kadastralesubjecten export configuration."""

    format = KadastralesubjectenCsvFormat()

    products = {
        "csv": {
            "endpoint": "/gob/brk2/kadastralesubjecten/?view=enhanced&ndjson=true",
            "secure_user": "gob",
            "exporter": csv_exporter,
            "filename": lambda: brk2_filename("kadastraal_subject", use_sensitive_dir=True),
