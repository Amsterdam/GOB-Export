...
@mock.patch('gobexport.keycloak.KEYCLOAK_URL', "any keycloak url")
@mock.patch('gobexport.keycloak.KEYCLOAK_CLIENT_ID', "any keycloak client id")
@mock.patch('gobexport.keycloak.KEYCLOAK_SECRET', "any keycloak secret")
